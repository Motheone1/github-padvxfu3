...
const FromHotelsHotelsScreen = () => {
  const navigate = useNavigate();
  const [selectedHotel, setSelectedHotel] = useState('');
  const [showMapButton, setShowMapButton] = useState(false);
  const { language } = useLanguage();

  // Hardcoded hotel data from "from hotels to arafa.xlsx"
  const hotelsData = [
    { 
      name: 'جوهرة البيان', 
      url: 'https://maps.app.goo.gl/M1L8jpwgvtKTF5U48'  
    },
    { 
      name: 'صفوة الشروق', 
      url: 'https://maps.app.goo.gl/T7RDJbnv2FdeVDsT8'  
    },
    { 
      name: 'الاحباب الكبرى', 
      url: 'https://maps.app.goo.gl/nagkMs2vAnmcn5ax8'  
    },
    { 
      name: 'روضة التوحيد', 
      url: 'https://maps.app.goo.gl/k9AGLKB4n3ikvWdw8'  
    },
    { 
      name: 'روضة الشريعة', 
      url: 'https://maps.app.goo.gl/EhvVsBMSJ5ZKLhBV9'  
    },
    { 
      name: 'العلاء٣', 
      url: 'https://maps.app.goo.gl/ZTX8mdrZFBMuKCwr5'  
    },
    { 
      name: 'مسارات السماح  مدخل الفندق من الجنب', 
      url: 'https://maps.app.goo.gl/MVcGrG8F5uc23JFaA'  
    }
  ];
  ...
  // Translations object
  const translations = {
    title: language === 'en' ? 'Hotels Selection' : 'اختيار الفنادق',
    description: language === 'en' 
      ? 'Select your starting hotel' 
      : 'اختر فندق البداية',
...
export default FromHotelsHotelsScreen;
